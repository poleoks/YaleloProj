...
df.to_excel(hv, index=False, sheet_name='Sheet1',startrow=0,header=True)
hv.close()
...
# Run the function
email_function(pbi_user,subject,body,filename)
print(f'{subject} Email sent !!!')

try:
    file='C:/Users/Administrator/Documents/Python_Automations/Harvest/YU-Harvest Data Logger.xlsx'
