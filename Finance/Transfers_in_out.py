...
active_warehouse = [
    ...
    {'WarehouseId' : 'Namasuba', 'Email':'namasubastore@yalelo.ug, pokuttu@yalelo.ug'},
    {'WarehouseId' : 'Production', 'Email':'pokuttu@yalelo.ug'},
...
#name the email subject
    ...
    if i == 'KyebandoDC':
        ...
        In case of any issues, please reply to pokuttu@yalelo.ug and jnanyonjo@yalelo.ug in copy for followup.
