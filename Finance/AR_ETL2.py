...
for i in glob.glob("C:/Users/Administrator/Documents/Python_Automations/"+"*xlsx"):
        os.remove(i)
        print(f"{i} removed")   
...
for i in range(190, 2000,1):
    ...
    formatted_date = datetime.today()  - relativedelta(days=i)
    formatted_date = formatted_date.strftime('%m/%d/%Y')
    date_ar= datetime.today() - relativedelta(days=i)
    date_ar = date_ar.strftime('%Y-%m-%d')
