...
#%%
def Capture_Event(event, x, y, dflags, params):
...
if __name__=="__main__":
	# Read the Image.
	img = cv.imread("C:/Users/Administrator/Documents/Python_Automations/Distribution/saved_images/distribution.png", 1)
	# Show the Image
	cv.imshow('image', img)
